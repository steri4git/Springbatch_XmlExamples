 ...
 */
public class Sb2StaxEventItemReader<T> extends
		AbstractItemCountingItemStreamItemReader<T> implements
		ResourceAwareItemReaderItemStream<T>, InitializingBean {

	private static final Log logger = LogFactory
			.getLog(Sb2StaxEventItemReader.class);
	...
	public Sb2StaxEventItemReader() {
		setName(ClassUtils.getShortName(Sb2StaxEventItemReader.class));
	}
